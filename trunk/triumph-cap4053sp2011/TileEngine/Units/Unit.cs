        ...
        public static Dictionary<string, BaseUnit> fromFile(ContentManager content, string filename, Dictionary<string, Ability> AbilityList)
        {
            ...
            using (StreamReader reader = new StreamReader(filename))
            {
                while (!reader.EndOfStream)
                {
                    ...
                    BaseUnit unit = new BaseUnit(unitParams[0].Trim(), Math.Min(99,int.Parse(unitParams[1].Trim())*6/5), int.Parse(unitParams[2].Trim()), int.Parse(unitParams[3].Trim()), int.Parse(unitParams[4].Trim()), int.Parse(unitParams[5].Trim()), int.Parse(unitParams[6].Trim()) * 9 / 10, int.Parse(unitParams[7].Trim()) * 3 / 2, int.Parse(unitParams[8].Trim()) * 9 / 10, int.Parse(unitParams[9].Trim()) * 3 / 2, int.Parse(unitParams[10].Trim()));
